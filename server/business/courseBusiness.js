...
var CourseBusiness = (function() {
    ...
    CourseBusiness.prototype.select = function(courseModel, callback) {
        ...
        sql = sql + " COL.col_description, CL.cla_min_size, CL.cla_max_size,CL.cla_address, CL.cla_location_name,";
    ...
    CourseBusiness.prototype.selectCourseTeaching = function(courseModel, callback) {
        ...
        connection.query(sql,function(err,courses){if(!err) {
            ...
            sql = sql + "C.cla_cost, C.cla_address,C.cla_location_name,C.cla_location_name, C.cla_max_size, COUNT(CR.clr_id) qtde_students,DATE_FORMAT(CT.clt_date,\"%m/%d/%Y\") AS clt_date_edit, ";
