...
var EmailBusiness = (function() {
    ...
    EmailBusiness.prototype.sendEmailConfirmation = function(email_to, name, link) {
        ...
        var mailOptions = {
            ...
            html: '<div style="width: 100%;text-align: center;margin-top:30px;"><img src="https://s3.amazonaws.com/cotutoweb/logo2.png" style="height:40px;"></div><div style="text-align: center;"><p style="font-size: 25px;color: #00669B;">Thank you '+name+' for signing up for Cotuto</p><p style="font-size: 20px;margin-top: -15px;">Click on link below ro confirm your email:</p><a href="'+link+'" style="font-size: 30px;font-weight: bold;color: #00669B;">Click here</a><div style="text-align: center;margin-top:60px;"><a href="https://www.facebook.com/cotutoeducation/"><img src="https://s3.amazonaws.com/cotutoweb/facebook.png" style="max-height:25px;"></a><a href="https://www.instagram.com/cotuto/"><img src="https://s3.amazonaws.com/cotutoweb/instagram.png" style="max-height:25px;"></a><a href="https://blog.cotuto.com/"><img src="https://s3.amazonaws.com/cotutoweb/blog2.png" style="max-height:25px;"></a><p style="font-size: 14px;margin-top: 4px;color: #6C6B6B;">Never Stop Learning</p></div></div>'
        };
